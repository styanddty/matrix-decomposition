...
%    mkdir(filepath);
% enddataset1=[pwd '\dataset\ORL_32x32.mat'];
...
for i=1:listlength
    ...
    save('ACandMIhat_rpca','MIhat_Original','MIhat_Diff','AC_Original','AC_Diff', 'methodName', 'methodName1_2', 'numID') 
%  data=load('ACandMIhat');
%  f=fieldnames(data);
%  for k=1:size(f,1)
%    xlswrite('ACandMIhat.xlsx',data.(f{k}),f{k})
%  end